...
// Array L   - AS
$L[33] = $D[array_search($S[33], $C)] ;
$M[33] = $E[array_search($S[33], $C)] ;
$N[33] = $F[array_search($S[33], $C)] ;
$O[33] = $G[array_search($S[33], $C)] ;
$P[33] = $H[array_search($S[33], $C)] ;
$Q[33] = $I[array_search($S[33], $C)] ;
$L[34] = 0 ;
$i = 0 ;
...
$E[5] = round($S[33] + (- $M[33] - sqrt($M[33]**2 - 4*$N[33]*($L[33]-$J[33]))) / (2*$N[33])) ;echo($E[5]);
